...
imagem_cidade = pygame.image.load('Imagens\Backgrounds\Cidade.png')
imagem_cidade = pygame.transform.scale(imagem_cidade, (1250, 400))
imagem_floresta = pygame.image.load('Imagens\Backgrounds\Floresta.png')
imagem_floresta = pygame.transform.scale(imagem_floresta, (1250, 400))
imagem_inverno = pygame.image.load('Imagens\Backgrounds\Vulcão.png')
imagem_inverno = pygame.transform.scale(imagem_inverno, (1250, 400))
imagem_praia = pygame.image.load('Imagens\Backgrounds\Praia.png')
imagem_praia = pygame.transform.scale(imagem_praia, (1250, 400))
imagem_velho = pygame.image.load('Imagens\Backgrounds\Velho Oeste.png')
